...
export const INITIAL_REQUESTS: SubstituteRequest[] = [
  ...
  },
  {
    ...
    applicantDepartment: '資訊科',
    leaveType: 'official',
    leaveDateStart: '2026-09-18',
    leaveDateEnd: '2026-09-18',
    reason: '奉派參加資訊群科中心課程研習（公假附公函）',
    paymentType: 'public',
    originalSession: {
      id: 'sess-lin-14',
      dayOfWeek: 5,
    ...
    substituteTeacherId: 't-cs-teacher2',
    substituteTeacherName: '蔡宏達 老師',
    status: 'approved',
    reviewedAt: '2026-09-16 09:20',
    reviewedBy: '陳雅筑 組長 (教學組)',
    createdAt: '2026-09-15 14:10',
    batchGroupId: 'batch-cal-lin-0918',
    clashStatus: {
      hasClash: false,
      severity: 'none',
      messages: ['檢核完成：蔡宏達老師週五第5節為空堂。'],
    },
  },
  {
    id: 'req-cal-lin-6',
  ...
  },
  {
    ...
    clashStatus: {
      hasClash: false,
      severity: 'none',
      messages: ['檢核完成：黃宗翰老師週五第7節為空堂。'],
    },
  },
  {
    id: 'req-cal-huang-5',
    requestNumber: '115-1-0006',
    requestType: 'substitute',
    applicantTeacherId: 't-ee-teacher2',
    applicantTeacherName: '黃宗翰 老師',
    applicantDepartment: '電機科',
    leaveType: 'sick',
    leaveDateStart: '2026-09-14',
    leaveDateEnd: '2026-09-14',
    reason: '因急性腸胃炎就醫，申請病假半日',
    paymentType: 'private',
    originalSession: {
      id: 'sess-huang-1',
      dayOfWeek: 1,
    ...
    substituteTeacherName: '鄭志華 主任',
    status: 'approved',
    reviewedAt: '2026-09-14 08:05',
    reviewedBy: '陳雅筑 組長 (教學組)',
    createdAt: '2026-09-14 07:40',
    batchGroupId: 'batch-cal-huang-0914',
    clashStatus: {
      hasClash: false,
      severity: 'none',
      messages: ['檢核完成：鄭志華主任週一第5節為空堂。'],
    },
  },
  {
    id: 'req-cal-huang-6',
  ...
  },
  {
    ...
    substituteTeacherId: 't-cs-guide',
    substituteTeacherName: '林美惠 老師',
    status: 'approved',
    reviewedAt: '2026-09-14 08:05',
    reviewedBy: '陳雅筑 組長 (教學組)',
    createdAt: '2026-09-14 07:40',
    ...
    clashStatus: {
      hasClash: false,
      severity: 'none',
      messages: ['檢核完成：林美惠老師週一第7節為空堂。'],
    },
  },
  {
    id: 'req-cal-cheng-5',
    requestNumber: '115-1-0007',
    requestType: 'substitute',
    applicantTeacherId: 't-ee-head',
    applicantTeacherName: '鄭志華 主任',
    applicantDepartment: '電機科',
    leaveType: 'official',
    leaveDateStart: '2026-09-15',
    leaveDateEnd: '2026-09-15',
    reason: '代表學校出席電機群科中心聯席會議（待審核）',
    paymentType: 'public',
    originalSession: {
      id: 'sess-cheng-3',
      dayOfWeek: 2,
    ...
    batchGroupId: 'batch-cal-cheng-0915',
    clashStatus: {
      hasClash: false,
      severity: 'none',
      messages: ['檢核完成：黃宗翰老師週二第5節為空堂。'],
    },
  },
  {
    id: 'req-cal-cheng-6',
  ...
  },
  {
    ...
    substituteTeacherId: 't-me-full',
    substituteTeacherName: '王大成 老師',
    status: 'pending',
    createdAt: '2026-09-14 16:20',
    batchGroupId: 'batch-cal-cheng-0915',
    clashStatus: {
